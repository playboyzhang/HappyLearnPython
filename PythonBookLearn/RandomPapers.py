...
for quizNum in range(35):
    ...
    quizFile = open('RandomPapers/capitalsquiz%s.txt' %(quizNum +1 ), 'w')
    answerKeyFile = open('RandomPapers/capitalsquiz_answers%s.txt' %(quizNum+1),'w')

    #Write out the header for the quiz
    quizFile.write('Name:\n\nDate:\n\nPeriod:')
    quizFile.write((' '*20 )+ 'State Captitals Quiz (From %s)'  % (quizNum +1))
    quizFile.write('\n\n')
